<?php
    ...
    $sqlAktivaL = "SELECT * FROM tbl_akun WHERE tipe_akun = 'aktiva lancar' AND tanggal BETWEEN '$tglMulai' AND '$tglSelesai' ";
    $ambilAktivaL = $conn->query($sqlAktivaL);
    $statusAktivaL = $ambilAktivaL->num_rows;

    // pencarian data dengan tipe aktiva tetap
    $sqlAktivaT = "SELECT * FROM tbl_akun WHERE tipe_akun = 'aktiva tetap' AND tanggal BETWEEN '$tglMulai' AND '$tglSelesai' ";
    $ambilAktivaT = $conn->query($sqlAktivaT);
    $statusAktivaT = $ambilAktivaT->num_rows;

    // pencarian data dengan tipe kewajiban
    $sqlKewajiban = "SELECT * FROM tbl_akun WHERE tipe_akun = 'kewajiban' AND tanggal BETWEEN '$tglMulai' AND '$tglSelesai' ";
    ...
    $sqlEkuitasModal = "SELECT SUM(kredit) FROM tbl_akun WHERE tipe_akun = 'ekuitas' AND nama_akun = 'modal' AND tanggal BETWEEN '$tglMulai' AND '$tglSelesai' ";
    ...
    $sqlEkuitasPrive = "SELECT SUM(debet) FROM tbl_akun WHERE tipe_akun = 'ekuitas' AND nama_akun = 'pengambilan prive' AND tanggal BETWEEN '$tglMulai' AND '$tglSelesai' ";
