<?php
	...
	if(isset($_POST["nama_akun"])) {
        ...
        // masukkan data baru pada tabel pendapatan
        $sqlPendapatan = "INSERT INTO tbl_pendapatan (id_user, id_akun, kode_transaksi, tanggal_pendapatan, nama_akun, keterangan, debet, kredit) VALUES ('$idUser', '$idAkun', '$kodeTransaksi', '$tanggal', '$namaAkun', '$keterangan', '$debet', '$kredit')";
