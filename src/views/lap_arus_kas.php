  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-12">
        ...
        <form action="src/components/ajax/lap_arus_kas.php" method="post" id="formLapArusKas">
          <div class="row">
            <div class="col-3">
              <!-- Date range -->
            ...
            <div class="col-8">
              <div class="form-group float-right">
                ...
                <div class="input-group">
                  ...
                  <a href="src/components/export_pages/print_lap_arus_kas.php?val=" class="btn btn-default mb-3" target="_blank" id="btnPrint">Print</a>
                </div>
              </div>
            </div>
          </div>
...
<!-- JS File-->
<!-- Data Pendapatan -->
<script src="src/dist/js/ajax/lap_arus_kas.js"></script>