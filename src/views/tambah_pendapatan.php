<?php
  ...
  // buat kode transaksi pendapatan
  $sqlKodeTransaksi = "SELECT max(right(kode_transaksi, 4)) AS kode_transaksi FROM tbl_pendapatan";
...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0 text-dark">Tambah Pendapatan</h1>
      </div><!-- /.col -->
      <div class="col-sm-6">
      ...
      <div class="col-md-12">
        ...
        <div class="card card-primary">
          <div class="card-header">
            <h3 class="card-title">Form Tambah Pendapatan</h3>
          </div>
          <!-- /.card-header -->
          <!-- form start -->
          <form action="src/components/ajax/tambah_pendapatan.php" method="post" id="formTambahPendapatan">
            <div class="card-body">
            ...
            <div class="card-footer">
              ...
              <a href="index.php?halaman=pendapatan" class="btn btn-secondary" id="btnBatalDanSelesai">Batal</a>
            </div>
          </form>
        </div>
        <!-- /.card -->
...
<!-- JS File-->
<!-- Tambah Barang -->
<script src="src/dist/js/ajax/tambah_pendapatan.js"></script>
